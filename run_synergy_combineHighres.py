...
logging.basicConfig( 
    ...
    filename="logfiles/combine_goodmask_Q0-05_p4_e1.log")
...
from kafka.input_output import Sentinel2Observations
from kafka.input_output.HighresObservations import HighresObservations
...
if __name__ == "__main__":
    ...
    runname = 'combine_goodmask_Q0-05_p4_e1'  #Used in output directory as a unique identifier
    ...
    Planet_emulator_folder = "/data/gp_emulators/prosail/planetlabs/"
    S2_emulator_folder = "/home/glopez/Multiply/src/py36/emus/sail"


    Planet_data_folder = "/data/001_planet_sentinel_study/planet/utm11n_sur_ref/"
    S2_data_folder = "/data/001_planet_sentinel_study/sentinel/11/S/KA"
    ...
    planet_observations = PlanetlabsObservations(Planet_data_folder,
                                                 Planet_emulator_folder,
                                                 state_mask)
    s2_observations = Sentinel2Observations(S2_data_folder,
                                                 S2_emulator_folder,
                                                 state_mask)

    combined_observations = HighresObservations([s2_observations, planet_observations])
    ...
    kf = LinearKalman(combined_observations, output, mask,
